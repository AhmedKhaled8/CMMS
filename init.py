...
tables['order_extras_ECG'] = ("CREATE TABLE order_extras_ECG("
    ...
    " expired_electrode " + found_block + ","
    " damaged_elec_package " + found_block + ","
    " Incorrect paper loading" + found_block + ","
    " Printing head problem" + found_block + ","
...
tables['order_extras_syringe_pump'] = ("CREATE TABLE order_extras_syringe_pump("
    " date_responded DATETIME,"
    " r_code MEDIUMINT UNSIGNED PRIMARY KEY NOT NULL,"
    " cracks in chassis " + found_block + ","
    " cracks in strain reliefs " + found_block + ","
    " Casters/Brakes not mounted " + found_block + ","
    " damaged AC plug " + found_block + ","
    " damaged line cord " + found_block + ","
    " tripped Breaker/Fuse " + found_block + ","
    " damaged detectors " + found_block + ","
    " unconnected cable connectors " + found_block + ","
    " malfunctional Controls/Switches " + found_block + ","
    
    " Indicators/Displays " + available_block + ","
    " Operational alarms" + available_block + ","
    " Audible signals " + available_block + ","
    " Operational labeling" + available_block + ","
    " Operational Flow-Stop Mechanisms" + available_block + ","
    " notes VARCHAR(255) NOT NULL DEFAULT 0,"
    " FOREIGN KEY (r_code) REFERENCES order_essentials(code)"
    " ON UPDATE CASCADE ON DELETE CASCADE);")
